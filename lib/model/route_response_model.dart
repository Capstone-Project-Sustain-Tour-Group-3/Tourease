class RouteResponseModel {
    ...
    factory RouteResponseModel.fromJson(Map<String, dynamic> json) => RouteResponseModel(
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        detailRute: json["detail_rute"] == null ? [] : List<DetailRute>.from(json["detail_rute"]!.map((x) => DetailRute.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "lokasi_awal": lokasiAwal?.toJson(),
        "detail_rute": detailRute == null ? [] : List<dynamic>.from(detailRute!.map((x) => x.toJson())),
    };
}
...
class DetailRute {
    ...
    factory DetailRute.fromJson(Map<String, dynamic> json) => DetailRute(
        destinasi: json["destinasi"] == null ? null : Destinasi.fromJson(json["destinasi"]),
...
class Destinasi {
    ...
    factory Destinasi.fromJson(Map<String, dynamic> json) => Destinasi(
        ...
        biayaMasuk: json["biaya_masuk"] == null ? null : BiayaMasuk.fromJson(json["biaya_masuk"]),
    );
...
class BiayaMasuk {
    ...
    factory BiayaMasuk.fromJson(Map<String, dynamic> json) => BiayaMasuk(
        raw: json["raw"],
        format: json["format"],
    );
